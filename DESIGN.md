...
- **Project detail:** Project summary, followed by the project-level Gantt, followed by the activity list. The summary uses compact content-sized Status, Dates, and Activity Progress regions, while Next Due receives the remaining width and wraps long activity names.
