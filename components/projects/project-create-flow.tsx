...
export function ProjectCreateFlow({data,onCancel,onSaved}:{data:AppData;onCancel:()=>void;onSaved:()=>void}){
  ...
  const preview=useMemo(()=>{if(!selected||!endDate)return null;try{return resolveTemplateSchedule(selected.activities,endDate)}catch{return null}},[selected,endDate]);
