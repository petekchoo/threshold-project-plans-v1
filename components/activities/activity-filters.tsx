...
export function useActivityFilters(data: AppData, query = '', fixedProjectId?: string) {
  ...
  return { rows, status, setStatus, priority, setPriority, owner, setOwner, type, setType, project, setProject, due, setDue, sort, setSort, showArchived, setShowArchived, today };
}
