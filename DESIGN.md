...
| PRJ-06 | Direct project-date edits preview and atomically move the complete or remaining schedule while preserving activity formation and completed history | Binding detail and acceptance matrix in `plans/PRJ-06-project-rescheduling.md`; pure planner in `lib/planning/project-reschedule.ts`; authoritative preview and commit RPCs | `preview_project_reschedule`, `reschedule_project`, schedule fingerprinting, deferred final validation, graph write mutex, and protected write boundary in `202609040001`–`202609040004`; transactional verification in `202609040002`, `202609040005`, and `202609040006` | Partial | The linked plan maps 34 executable PRJ-06 planner tests plus 12 shared timing tests. Live database verification covers authoritative planning, successful atomic persistence, rollback, timing and exception preservation, completed and archived work, internal and cross-project dependencies, authentication/direct-write protection, stale fingerprints, and two-session lock serialization. Preview UI and core-journey coverage remain for Slices 3–4. |
