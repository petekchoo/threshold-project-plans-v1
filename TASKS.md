...
- Design and deliver project schedule shifting so a user can move a project to new calendar dates and preview an atomic shift of its active activities. Preserve activity durations, relative spacing, dependency relationships, and project-relative timing rules. Define resize behavior separately from whole-project movement, including conflict handling, exceptions, archived activities, confirmation, and rollback; cover the resulting client calculations and database transaction path with automated tests.
