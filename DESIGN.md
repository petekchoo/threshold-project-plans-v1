...
| QA-04 | Database integration tests | PRJ-06 pgTAP suite in `supabase/tests/prj06_project_rescheduling.sql`; transactional live verification migrations `202609040002`, `202609040005`, and `202609040006` | Partial | PRJ-06 covers atomic success/rollback, timing rules, exceptions, archive behavior, permissions, stale fingerprints, and concurrency. Extend reusable database coverage to activity saves, cycle rejection, and broader RLS behavior. | Design: [#confirmed-project-constraints](#confirmed-project-constraints), [#technical-direction](#technical-direction); Verification: `pnpm db:test` |
