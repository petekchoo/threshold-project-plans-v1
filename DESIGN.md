...
| --- | --- | --- | --- |
| unit-vitest | unit | `pnpm test` | `lib/planning/scheduling.test.ts`; `lib/planning/project-reschedule.test.ts`; `components/projects/reschedule-preview-dialog.test.ts` |
